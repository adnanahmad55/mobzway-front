                                            ...
                                            <div className="carousel-item">
                                                <div className="row">
                                                    <div className="col-md-7">
                                                        ...
                                                        />
                                                        <div className="hero__description">
                                                            Delivering multiple options for developing-quality Keno games for the {country} marketplace. Our Keno game options include safe, reliable, fast and aesthetically pleasing game images in Web and Mobile versions.
                            ...
                            <div className="row">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <li>Products with support in English and {country} languages offered to {country} players
                                        </li>
                                        <li>
                                        ...
                                        <li>Free Business Consultation to enhance {country} gamblers and startups
                                        </li>
