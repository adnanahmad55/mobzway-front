                                    ...
                                    <div className="carousel-inner">
                                            ...
                                            <div className="row">
                                                <div className="col-md-7">
                                                    <h2 data-hk="s40-1-12" className="hero__title">
                                                        ...
                                                        {dictionary[lang].bannerSlideTitle1}
                                                    </h2>
                                                    <img
                                                    ...
                                                    <div className="hero__description">
                                                        {dictionary[lang].bannerSlideText1}
                                        ...
                                        <div className="carousel-item">
                                            <div className="row">
                                                <div className="col-md-7">
                                                    <h2 data-hk="s40-1-12" className="hero__title">
                                                        {dictionary[lang].bannerSlideTitle2}
                                                    </h2>
                                                    <img
                                                        className="d-block d-md-none mb-3 w-100"
                                                    ...
                                                    />
                                                    <div className="hero__description">
                                                        {dictionary[lang].bannerSlideText2}
                                        ...
                                        <div className="carousel-item">
                                            <div className="row">
                                                <div className="col-md-7">
                                                    <h2 data-hk="s40-1-12" className="hero__title">
                                                        {dictionary[lang].bannerSlideTitle3}
                                                    </h2>
                                                    <img
                                                        className="d-block d-md-none mb-3 w-100"
                                                    ...
                                                    />
                                                    <div className="hero__description">
                                                        {dictionary[lang].bannerSlideText3}
                                                    </div>
                                                </div>
                                                <div className="col-md-5 d-none d-md-block">
                                                    <img
                                            ...
                                            <div className="row">
                                                <div className="col-md-7">
                                                    <h2 data-hk="s40-1-12" className="hero__title">
                                                        ...
                                                        {dictionary[lang].bannerSlideTitle4}
                                                    </h2>
                                                    <img
                                                        className="d-block d-md-none mb-3 w-100"
                                                        src="/assets/images/ludo.webp"
                                                    ...
                                                    />
                                                    <div className="hero__description">
                                                        {dictionary[lang].bannerSlideText4}
                                                    </div>
                                                </div>
                                                <div className="col-md-5 d-none d-md-block">
                                                    <img
            ...
            >
                <div className="container">
                    <h1 className="sub_title text-center">
                        <span className="yellow">{dictionary[lang].H1} </span>{" "}
                        <span className="black">{dictionary[lang].H12}</span>
                    </h1>
                    <p
                        style={{ marginBottom: 15, color: "#000", fontSize: 17 }}
                        className="content"
                    >
                        {dictionary[lang].H1Text}
            ...
            <section className="product-sec">
                <div className="container">
                    <h2 className="sub_title" style={{ textAlign: "center" }}>
                        <span className="yellow">{dictionary[lang].Offer}</span>{" "}
                    ...
                    <div className="row">
                        <div className="col-md-12 text-center">
                            ...
                            >
                                <h2 className="sub_title">
                                    <span className="yellow">{dictionary[lang].About}</span>{" "}
                        ...
                        <div className="col-6 mb-0 col-xl-3 col-lg-3 mb-3 mb-md-0">
                            ...
                            >
                                ...
                                <div className="title_pltfm">{dictionary[lang].RapidLaunch}</div>
                                <p className="content">
                                    {dictionary[lang].RapidLaunchText}
                                </p>
                            </div>
                        </div>
                        <div className="col-6 mb-0 col-xl-3 col-lg-3 mb-3 mb-md-0">
                            ...
                            >
                                ...
                                <div className="title_pltfm">{dictionary[lang].ExclusiveBranding}</div>
                                <p className="content">
                                    {dictionary[lang].ExclusiveBrandingText}
                                </p>
                            </div>
                        </div>
                        <div className="col-6 col-xl-3 col-lg-3 mb-3 mb-md-0">
                            ...
                            >
                                ...
                                <div className="title_pltfm">{dictionary[lang].MinimalInvestment}</div>
                                <p className="content">
                                    {dictionary[lang].MinimalInvestmentText}
                                </p>
                            </div>
                        </div>
                        <div className="col-6  col-xl-3 col-lg-3">
                            ...
                            >
                                ...
                                <div className="title_pltfm">{dictionary[lang].SecurityReliability}</div>
                                <p className="content">
                                    {dictionary[lang].SecurityReliabilityText}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-md-12 text-center">
                            ...
                            >
                                <h2 className="sub_title">
                                    <span className="yellow">{dictionary[lang].FindOut}</span>{" "}
                        ...
                        <div className="col-md-12 text-center">
                            ...
                            <div
                                ...
                                style={{ paddingBottom: 15 }}
                            >
                                {dictionary[lang].FindOutText2}
                            </div>
                            <div
                                className="help_cotnent text-center"
                                style={{ paddingBottom: 35 }}
                            >
                                {dictionary[lang].FindOutText3}
                ...
                <div className="container">
                    ...
                    <div className="row">
                        <div className="col-md-6 align-self-center">
                            ...
                            >
                                <h2 className="sub_title">
                                    <span className="yellow">{dictionary[lang].EngagementModel}</span>{" "}
                                    {/* <span className="black">Model</span> */}
                                </h2>
                            </div>
                            <div className="engage_left">
                                <p className="eng_content">
                                    {dictionary[lang].EngagementModelText}
                                </p>
                                <div className="sub_title_eng">{dictionary[lang].BuyWhite}</div>
                                <p className="sub_content_eng">
                                    {dictionary[lang].BuyWhiteText}
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            >
                                ...
                                >
                                    <h2 className="sub_title">
                                        <span className="yellow">{dictionary[lang].WhySelectUs} </span>{" "}
                                ...
                                >
                                    <li>
                                        {dictionary[lang].WhySelectUs1}

                                    </li>
                                    <li>
                                        {dictionary[lang].WhySelectUs2}

                                    </li>
                                    <li>
                                        {dictionary[lang].WhySelectUs3}

                                    </li>
                                    <li>{dictionary[lang].WhySelectUs4}
                                    </li>
                                    <li>{dictionary[lang].WhySelectUs5}
                                    </li>
                                    <li>
                                        {dictionary[lang].WhySelectUs6}
                                    </li>
                                    <li>{dictionary[lang].WhySelectUs7}
                                    </li>
                                    <li>{dictionary[lang].WhySelectUs8}
                                    </li>
                                    <li>{dictionary[lang].WhySelectUs9}</li>
                ...
                <div className="container c-1">
                    <div className="col-md-12 text-center">
                        <h3 className="sub_title ft_40">
                            <span className="yellow">{dictionary[lang].WhatDo}</span>{" "}
