...
export default function HireGameDevelopers() {
        ...
        <>
            ...
            >
                ...
                <div className="wel_come_container">
                    <h1 className="welcome_text wel">
                        Hire Best game developers in India | Get Dedicated Developer
                    </h1>
            ...
            <span className="black">Development Company in Bangladesh</span>
                    ...
                    <p
                        ...
                        className="content"
                    >
                        The game developers of India are among the most professional and creative in their field and have earned India the distinction of being the number one location to find high-quality, affordable talent for your organization. As an industry-leading provider of dedicated game developers in India, Mobzway is committed to the delivery of high-quality work, fast development times and complete control over the development process of your game.
                    </p>
                    <p className="content" style={{ color: "#000", fontSize: 17 }}>
                        Whether you require developers for Unity, Unreal Engine, HTML5, multiplayer server development, mobile game development or a complete package of game creation, our game developers have extensive experience developing games for a worldwide audience.
                    </p>
                </div>
            </section>
                    ...
                    <div className="col-md-12 text-center">
                        ...
                        >
                            <h2 className="sub_title">
                                <span className="yellow">Why Hire Game </span>{" "}
                                <span className="black"> Developers in India?</span>
                            </h2>
                        </div>
                    </div>
                            ...
                            <div className="row">
                                    ...
                                    <div className="card plateform-card">
                                        ...
                                        <div className="card-body">
                                            <h5 className="card-title cards text-center">
                                                Outstanding Technical Skill and Global Experience
                                            </h5>
                                ...
                                >
                                    <div className="card  plateform-card">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <p className="card-text text-center text-dark">
                                                India offers an optimal combination of low prices and a high level of quality talent, allowing start-ups and large companies alike to develop and launch products quickly and easily.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                >
                                    <div className="card  plateform-card">
                                        ...
                                        <div className="card-body">
                                            <h5 className="card-title cards text-center">Complete Control Over Your Game Development</h5>
                                            <p className="card-text text-center text-dark">
                                                You will have full control over your game development when you hire game developers in India. You will also have direct access to your developers and receive daily updates on your projects. You will have complete flexibility in your working models, including the option to use Agile project management methodologies for the development of your games.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                >
                                    <div className="card  plateform-card">
                                        ...
                                        <div className="card-body">
                                            <h5 className="card-title cards text-center">Quick Delivery of Your Projects</h5>
                                            <p className="card-text text-center text-dark">
                                                Utilizing the developers' experience, the project will be executed swiftly and seamlessly. Our developers' proficiency in their niches makes it possible to develop each of your projects not only in a shorter time frame but also more efficiently compared to developers who lack this specialization.
                                            </p>
                                        </div>
                                    </div>
                                </div>
   ...
   <h1><span>FEATURES</span> OF POKER GAME DEVELOPED BY US</h1>
                    ...
                    <div className="col-md-12 text-center">
                        ...
                        >
                            <h2 className="sub_title">
                                <span className="yellow">Game Developer Hiring </span>{" "}
                                <span className="black">
                                    Models that are Dedicated
                                </span>
                            </h2>
                        </div>
                    </div>
                    ...
                    <div className="row row1 row1add">
                        <div className="col-lg-4 col-md-6 col1">
                            <div className="row">
                                ...
                                <div className="col-md-12 col-sm-12 col-12">
                                    <h3 className='text-center'>Full-Time Dedicated Developer</h3>
                                </div>
                                <div className="col-md-12">
                                    <p>
                                        Developers will be working solely on your project, this is the best option for the long-term game development.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6 col1">
                            <div className="row">
                                ...
                                <div className="col-md-12 col-sm-12 col-12">
                                    <h3 className='text-center'>Part-Time Developer</h3>
                                </div>
                                <div className="col-md-12">
                                    <p>
                                        This is the best option for upgrades, live-ops, seasonal events, or for partial development needs.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6 col1">
                            <div className="row">
                                ...
                                <div className="col-md-12 col-sm-12 col-12">
                                    <h3 className='text-center'>Hourly Game Developer Hiring</h3>
                                </div>
                                <div className="col-md-12">
                                    <p>
                                        This is the best option for quick fixes, feature updates, or technical enhancements.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <div className="container c-1">
                    <div className="row">
                        <div className="col-md-12 text-center">
                            ...
                            >
                                <h2 className="sub_title">
                                    <span className="yellow">Different Types Of Game </span>{" "}
                                    <span className="black">
                                        Developers You Can Hire in India
                                    </span>
                                </h2>
                            </div>
                        ...
                        <div className="col-md-6">
                            ...
                            >
                                <li><b>Unity Game Developers:</b> pecialists in creating mobile, 2D, 3D, and cross-platform video games. </li>
                                <li>
                                    <b>Unreal Engine Developers:</b> Suitable for creating high-end 3D, VR, simulation, or AAA-quality and advanced video games.
                                </li>
                                <li>
                                    <b>HTML5/JavaScript Game Developers:</b> Create lightweight and mobile-friendly browser-based games.
                                </li>
                                <li>
                                    <b>Mobile Game Developers:</b> Develop for Android, IOS, hybrid, and cross-platform App Development.
                                </li>
                                <li><b>Multiplayer/Game Server Developers:</b> Provide expertise with Photon, SmartFox, WebRTC, Node.js, and Socket.io.</li>
                                <li>
                                    <b>Game Designers/Artists:</b> Including concept artists, 3D modelers, animators, and UI/UX designers.
                                </li>
   ...
   <h1><span>HIRE</span> POKER GAME DEVELOPER</h1>
                    ...
                    <div className="col-md-12 text-center">
                        ...
                        >
                            <h2 className="sub_title">
                                <span className="yellow">Hiring with Us Is </span>{" "}
                                <span className="black">Easy and Transparent!</span>
                                {/*2*/}
                            </h2>
                    ...
                    <div className="row row1">
                        ...
                        >
                            <p className="hire-para">
                                <b>You convey your requirement:</b> The genre of the game, platform, timeline, and features you envision for your game will help us determine which developer(s) have the right blend of skills required for your project!
                                <br />
                                <br />
                                <b>Developer Profiles:</b> After you have shortlisted your developer, we will present the profiles of the developers that we match with you to check their skills and experience and choose the right ones for your project.
                                <br />
                                <br />
                                <b>Interview Developers:</b> After shortlisting your developers, you interview them to evaluate their programming skills, problem-solving skills, communication skills, and at the same time view their work samples!
                                <br />
                                <br />
                                <b>Simple Process to Hire and Onboard:</b> Once you select a developer, we will assist with getting them started ASAP, as soon as you provide us with your instructions!
                                <br />
                                <br />
                                <b>Tracking your Projects:</b> Daily updates of the project status including: Milestones achieved; Daily report on the development process and; code review is made available throughout the entire development process.
                            ...
                            <div className="row">
                                ...
                                >
                                    <div className="card  plateform-card">
                                        ...
                                        <div className="card-body">
                                            <h5 className="card-title cards text-center">Backend</h5>
                                            <p className="card-text text-center text-dark">
                                                {" "}
                                ...
                                >
                                    <div className="card  plateform-card">
                                        ...
                                        <div className="card-body">
                                            <h5 className="card-title cards text-center">Graphics creation software</h5>
                                            <p className="card-text text-center text-dark">
                                                {" "}
