...
export default function GameDevelopmentCompanyInUSA() {
    return (
        <>
            ...
            <span className="black">Development Company in Bangladesh</span>
                    ...
                    <p
                        ...
                        className="content"
                    >
                        Mobzway is a top-notch Game development company in USA, and the company is providing complete game development services from the very first step to the final launch for mobile, web, PC, and console games.
                    </p>
                    <p className="content" style={{ color: "#000", fontSize: 17 }}>
                        Mobzway has a great focus on innovation, performance, and user engagement, and thus, it offers businesses the helping hand to convert their ideas into successful gaming products.
                    </p>
                </div>
            </section>
   ...
   <h1 class="text-white"><span>WE</span> BUILD THE POKER GAME FOR ALL PLATFORMS</h1>
                    ...
                    <div className="col-md-12 text-center">
                        ...
                        >
                            <h2 className="sub_title">
                                <span className="yellow">Why Choose Mobzway as Your </span>{" "}
                    ...
                    <div className="col-md-12 col1 wow" data-wow-duration="1s">
                        <p className="hire-para col-md-12 para-plateform text-center">
                            Our experts blend visionary designs, state-of-the-art technology, and market orientation to bring forth the best games.
                            ...
                            <div className="row">
                                    ...
                                    <div className="card plateform-card">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <ul className='why_content why_content_dark p-0 my-2'>
                                                <li className='text-dark'>Games for mobile, PC & console</li>
                                                <li className='text-dark'>2D, 3D and multiplayer games </li>
                                                <li className='text-dark'>Development of cross-platform games</li>
                                ...
                                >
                                    <div className="card  plateform-card">
                                        ...
                                        <div className="card-body">
                                            ...
                                            <ul className='why_content why_content_dark p-0 my-2'>
                                                <li className='text-dark'>Proficient Unity, Unreal and HTML5 developers</li>
                                                <li className='text-dark'>Agile methodology</li>
                                                <li className='text-dark'>Fully committed development teams</li>
                                ...
                                >
                                    <div className="card  plateform-card">
                                        ...
                                        <div className="card-body">
                                            <h5 className="card-title cards text-center">End-to-End Development</h5>
                                            <ul className='why_content why_content_dark p-0 my-2'>
                                                <li className='text-dark'>Design and prototyping of the game</li>
                                                <li className='text-dark'>Testing and development</li>
                                                <li className='text-dark'>Janitor and support after launching</li>
                                ...
                                >
                                    <div className="card  plateform-card">
                                        ...
                                        <div className="card-body">
                                            <h5 className="card-title cards text-center">Scalable & Secure Solutions</h5>
                                            <ul className='why_content why_content_dark p-0 my-2'>
                                                <li className='text-dark'>Infrastructure based on the cloud</li>
                                                <li className='text-dark'>Systems with highly secure backend</li>
                                                <li className='text-dark'>Gameplay that is optimized for performance</li>
                    ...
                    <div className="row row1 row1add">
                        <div className="col-lg-4 col-md-6 col1">
                            <div className="row">
                                ...
                                <div className="col-md-12">
                                    <p>
                                        Development for Android & iOS, Games: casual, hyper-casual, & real-money, Mobile gameplay with high-performance
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6 col1">
                            <div className="row">
                                ...
                                <div className="col-md-12 col-sm-12 col-12">
                                    <h3 className='text-center'>PC & Console Game Development</h3>
                                </div>
                                <div className="col-md-12">
                                    <p>
                                        Development of AAA & indie games, Cross-platform support, Graphics & physics optimized
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4 col-md-6 col1">
                            <div className="row">
                                ...
                                <div className="col-md-12">
                                    <p>
                                        Systems for multiplayer in real-time, Integration of matchmaking & leaderboard, Architecture of a secure server
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="col-lg-4 col-md-6 col1">
                            <div className="row">
                                ...
                                <div className="col-md-12 col-sm-12 col-12">
                                    <h3 className='text-center'>Casino & iGaming Game Developmen</h3>
                                </div>
                                <div className="col-md-12">
                                    <p>
                                        Development of slot, table, & card games, Platforms for sportsbook & casino, Gaming solutions that are RNG-certified
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="col-md-12 text-center">
                        ...
                        >
                            <h2 className="sub_title">
                                ...
                                <span className="black">
                                    {" "}
                                    Our Game Development Solutions{/*< /span*/}
                                </span>
                            </h2>
                        </div>
                    </div>
                            ...
                            <div className="row">
                                ...
                                >
                                    <div className="card plateform-card">
                                        ...
                                        <div className="card-body">
                                            <h5 className="card-title cards text-center">
                                                UI/UX that engage the user & gameplay mechanics
                                            </h5>
                                            {/* <p className="card-text text-center text-dark">
                                ...
                                >
                                    <div className="card  plateform-card">
                                        ...
                                        <div className="card-body">
                                            <h5 className="card-title cards text-center">Multi-language & global monetization</h5>
                                            {/* <p className="card-text text-center text-dark">
                                                {" "}
                                ...
                                >
                                    <div className="card  plateform-card">
                                        ...
                                        <div className="card-body">
                                            <h5 className="card-title cards text-center">Secure payment & analytics systems</h5>
                                            {/* <p className="card-text text-center text-dark">
                                                {" "}
            ...
            <section className="solutions">
                <div className="container c-1">
                    ...
                    <div className="col-md-12 text-center">
                        ...
                        >
                            <h2 className="sub_title">
                                <span className="yellow">Gaming Industry </span>{" "}
                                <span className="black">Opportunity in USA</span>
                            </h2>
                            <p>he United States continues to be one of the leading gaming industries throughout the world because of several factors:</p>
                        </div>
                    </div>
                    <div className="row row1">
                        ...
                        >
                            <p className="para-1">
                                Gaming is Highly Engaging for Users Across All Gaming Platforms.
                                <br />
                                <br />
                                There is a Multi-Billion Dollar Growth Rate of Mobile and Online Gaming.
                                <br />
                                <br />
                                Demand for Innovative and Engaging Experiences Continues to Grow.
                                <br />
                                <br />
                                Mobzway provides Businesses with Future-Ready Game Development Solutions for Success in this Fast-Paced Industry. we are premier Game development company in USA.
            ...
            <section className="developer">
                <div className="container c-1">
                    ...
                    <div className="col-md-12 text-center">
                        ...
                        >
                            <h2 className="sub_title">
                                ...
                                <span className="black">Technology Stack</span>
                    ...
                    <div className="row row1">
                        ...
                        >
                            <p className="hire-para">
                                Mobzway utilizes the latest Gaming Development Technologies, including:
                                <br />
                                <br />
                                ...
                                <br />
                                <br />
                                C#, C++, and multiple Backend Frameworks.
                                <br />
                                <br />
                                Cloud Hosting through AWS and Azure.
            ...
            <section className="get_in-touch get ">
                <div className="container c-1">
                    <div className="col-md-12 text-center">
                        ...
                        >
                            <h2 className="sub_title">
                                <span className="black_bg_head_yellow">Develop Your Next </span>{" "}
                    ...
                    <div className="sub_head text-center">
                        ...
                        >
                            As a leading and trusted Game development company in USA, Mobzway provides expert game development services that will result in innovative, engaging games that will create revenues for your Business.
                        </h3>
                    </div>
